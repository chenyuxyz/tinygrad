...
pm_pyrender_extra = PatternMatcher([
  ...
  (UPat(set(syms.keys())-{Ops.SUB, Ops.CMPNE, Ops.CDIV, Ops.CMOD}, src=(UPat(Ops.CONST, src=(), name="y"), UPat(name="z")),
  ...
  (UPat(set(syms.keys())-{Ops.SUB, Ops.CDIV, Ops.CMOD}, src=(UPat(name="y"), UPat(Ops.CONST, src=(), name="z")), name="x"),
